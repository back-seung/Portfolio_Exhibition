	...
	<div class="inputForm col-md-4 offset-md-4 shadow-lg">
		<div class="mt-4 p-4">
			<div class="text-center">
				<h2 class="display-3 fw-bolder">USER INFO</h2>
				<hr>
			</div>
			<div class="mt-3 mb-3">CURRENT ID : ${user.id}</div>
			<div class="mt-3 mb-3">CURRENT NAME : ${user.name}</div>
			<hr>
			<div class="text-center">
				<div class="form-floating mb-3 nameForm">
					<a class="btn btn-secondary" href="userModForm?id=${user.id}">정보수정하기</a>
					<a class="btn btn-secondary" href="userDelete?id=${user.id}">탈퇴하기</a>
				</div>
			</div>
		</div>
	</div>
